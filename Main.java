...
import java.util.*;
public class MainApp { private static Scanner sc = new
Scanner(System.in); private static List<Device> devices
= new ArrayList<>(); private static List<Alert> alerts =
new ArrayList<>();
...
System.out.print("Enter choice: ");
 choice = sc.nextInt();
 sc.nextLine();
 switch(choice) { case 1: addDevice();
break; case 2: addSensor(); break;
case 3: setThreshold(); break; case 4:
ingestReading(); break; case 5:
generateAlert(); break; case 6:
acknowledgeAlert(); break; case 7:
createTicket(); break; case 8: closeTicket();
break; case 9: showAlerts(); break;
...
s.addReading(r);
 ...
 private static void generateAlert() { for (Device d : devices) { for (Sensor s
: d.getSensors()) { for (Reading r : s.getReadings()) { if
(s.getThreshold() != null && s.getThreshold().isBreached(r.getValue())) {
